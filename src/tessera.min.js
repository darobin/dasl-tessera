...
var i = (t6, ...e12) => {
  const o14 = 1 === t6.length ? t6[0] : e12.reduce(((e13, s5, o15) => e13 + ((t7) => {
    if (true === t7._$cssResult$) return t7.cssText;
    if ("number" == typeof t7) return t7;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + t7 + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(s5) + t6[o15 + 1]), t6[0]);
  return new n(o14, t6, s);
};
var S = (s5, o14) => {
  if (e) s5.adoptedStyleSheets = o14.map(((t6) => t6 instanceof CSSStyleSheet ? t6 : t6.styleSheet));
  else for (const e12 of o14) {
    const o15 = document.createElement("style"), n10 = t.litNonce;
    void 0 !== n10 && o15.setAttribute("nonce", n10), o15.textContent = e12.cssText, s5.appendChild(o15);
  }
};
...
var y = class extends HTMLElement {
  ...
  static createProperty(t6, s5 = b) {
    if (s5.state && (s5.attribute = false), this._$Ei(), this.prototype.hasOwnProperty(t6) && ((s5 = Object.create(s5)).wrapped = true), this.elementProperties.set(t6, s5), !s5.noAccessor) {
      const i9 = Symbol(), h5 = this.getPropertyDescriptor(t6, i9, s5);
      void 0 !== h5 && e2(this.prototype, t6, h5);
    }
  }
  static getPropertyDescriptor(t6, s5, i9) {
    const { get: e12, set: r9 } = h(this.prototype, t6) ?? { get() {
      return this[s5];
    }, set(t7) {
      this[s5] = t7;
    } };
    return { get: e12, set(s6) {
      const h5 = e12?.call(this);
      r9?.call(this, s6), this.requestUpdate(t6, h5, i9);
  ...
  _$ET(t6, s5) {
    ...
    if (void 0 !== e12 && true === i9.reflect) {
      const h5 = (void 0 !== i9.converter?.toAttribute ? i9.converter : u).toAttribute(s5, i9.type);
      this._$Em = t6, null == h5 ? this.removeAttribute(e12) : this.setAttribute(e12, h5), this._$Em = null;
    }
  }
  _$AK(t6, s5) {
    const i9 = this.constructor, e12 = i9._$Eh.get(t6);
    if (void 0 !== e12 && this._$Em !== e12) {
      const t7 = i9.getPropertyOptions(e12), h5 = "function" == typeof t7.converter ? { fromAttribute: t7.converter } : void 0 !== t7.converter?.fromAttribute ? t7.converter : u;
      this._$Em = e12;
      const r9 = h5.fromAttribute(s5, t7.type);
      this[e12] = r9 ?? this._$Ej?.get(e12) ?? r9, this._$Em = null;
    }
  }
  requestUpdate(t6, s5, i9) {
    if (void 0 !== t6) {
      const e12 = this.constructor, h5 = this[t6];
      if (i9 ??= e12.getPropertyOptions(t6), !((i9.hasChanged ?? f)(h5, s5) || i9.useDefault && i9.reflect && h5 === this._$Ej?.get(t6) && !this.hasAttribute(e12._$Eu(t6, i9)))) return;
      this.C(t6, s5, i9);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t6, s5, { useDefault: i9, reflect: e12, wrapped: h5 }, r9) {
    i9 && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(t6) && (this._$Ej.set(t6, r9 ?? s5 ?? this[t6]), true !== h5 || void 0 !== r9) || (this._$AL.has(t6) || (this.hasUpdated || i9 || (s5 = void 0), this._$AL.set(t6, s5)), true === e12 && this._$Em !== t6 && (this._$Eq ??= /* @__PURE__ */ new Set()).add(t6));
  }
  async _$EP() {
...
var y2 = (t6) => (i9, ...s5) => ({ _$litType$: t6, strings: i9, values: s5 });
var x = y2(1);
var b2 = y2(2);
var w = y2(3);
...
var V = (t6, i9) => {
  const s5 = t6.length - 1, o14 = [];
  let r9, l5 = 2 === i9 ? "<svg>" : 3 === i9 ? "<math>" : "", c6 = f2;
  for (let i10 = 0; i10 < s5; i10++) {
    ...
    l5 += c6 === f2 ? s6 + n3 : d3 >= 0 ? (o14.push(a4), s6.slice(0, d3) + e3 + s6.slice(d3) + h2 + x2) : s6 + h2 + (-2 === d3 ? i10 : x2);
  }
  return [P(t6, l5 + (t6[s5] || "<?>") + (2 === i9 ? "</svg>" : 3 === i9 ? "</math>" : "")), o14];
};
var N = class _N {
  constructor({ strings: t6, _$litType$: s5 }, n10) {
    let r9;
    this.parts = [];
    let c6 = 0, a4 = 0;
    const u5 = t6.length - 1, d3 = this.parts, [f5, v2] = V(t6, s5);
    if (this.el = _N.createElement(f5, n10), C.currentNode = this.el.content, 2 === s5 || 3 === s5) {
    ...
    for (; null !== (r9 = C.nextNode()) && d3.length < u5; ) {
      if (1 === r9.nodeType) {
        if (r9.hasAttributes()) for (const t7 of r9.getAttributeNames()) if (t7.endsWith(e3)) {
          const i9 = v2[a4++], s6 = r9.getAttribute(t7).split(h2), e12 = /([.?@])?(.*)/.exec(i9);
          d3.push({ type: 1, index: c6, name: e12[2], strings: s6, ctor: "." === e12[1] ? H : "?" === e12[1] ? I : "@" === e12[1] ? L : k }), r9.removeAttribute(t7);
        } else t7.startsWith(h2) && (d3.push({ type: 6, index: c6 }), r9.removeAttribute(t7));
        if ($.test(r9.tagName)) {
          const t7 = r9.textContent.split(h2), s6 = t7.length - 1;
          if (s6 > 0) {
            r9.textContent = i3 ? i3.emptyScript : "";
            for (let i9 = 0; i9 < s6; i9++) r9.append(t7[i9], l2()), C.nextNode(), d3.push({ type: 2, index: ++c6 });
            r9.append(t7[s6], l2());
          }
        }
...
function S2(t6, i9, s5 = t6, e12) {
  if (i9 === T) return i9;
  let h5 = void 0 !== e12 ? s5._$Co?.[e12] : s5._$Cl;
  const o14 = c3(i9) ? void 0 : i9._$litDirective$;
  return h5?.constructor !== o14 && (h5?._$AO?.(false), void 0 === o14 ? h5 = void 0 : (h5 = new o14(t6), h5._$AT(t6, s5, e12)), void 0 !== e12 ? (s5._$Co ??= [])[e12] = h5 : s5._$Cl = h5), void 0 !== h5 && (i9 = S2(t6, h5._$AS(t6, i9.values), h5, e12)), i9;
}
var M = class {
  constructor(t6, i9) {
  ...
  u(t6) {
    const { el: { content: i9 }, parts: s5 } = this._$AD, e12 = (t6?.creationScope ?? r3).importNode(i9, true);
    C.currentNode = e12;
    let h5 = C.nextNode(), o14 = 0, n10 = 0, l5 = s5[0];
    for (; void 0 !== l5; ) {
      if (o14 === l5.index) {
        let i10;
        2 === l5.type ? i10 = new R(h5, h5.nextSibling, this, t6) : 1 === l5.type ? i10 = new l5.ctor(h5, l5.name, l5.strings, this, t6) : 6 === l5.type && (i10 = new z(h5, this, t6)), this._$AV.push(i10), l5 = s5[++n10];
      }
      o14 !== l5?.index && (h5 = C.nextNode(), o14++);
    }
...
var R = class _R {
  ...
  constructor(t6, i9, s5, e12) {
    this.type = 2, this._$AH = E, this._$AN = void 0, this._$AA = t6, this._$AB = i9, this._$AM = s5, this.options = e12, this._$Cv = e12?.isConnected ?? true;
  }
  get parentNode() {
  ...
  $(t6) {
    const { values: i9, _$litType$: s5 } = t6, e12 = "number" == typeof s5 ? this._$AC(t6) : (void 0 === s5.el && (s5.el = N.createElement(P(s5.h, s5.h[0]), this.options)), s5);
    if (this._$AH?._$AD === e12) this._$AH.p(i9);
    else {
      const t7 = new M(e12, this), s6 = t7.u(this.options);
  ...
  k(t6) {
    ...
    const i9 = this._$AH;
    let s5, e12 = 0;
    for (const h5 of t6) e12 === i9.length ? i9.push(s5 = new _R(this.O(l2()), this.O(l2()), this, this.options)) : s5 = i9[e12], s5._$AI(h5), e12++;
...
var k = class {
  ...
  constructor(t6, i9, s5, e12, h5) {
    this.type = 1, this._$AH = E, this._$AN = void 0, this.element = t6, this.name = i9, this._$AM = e12, this.options = h5, s5.length > 2 || "" !== s5[0] || "" !== s5[1] ? (this._$AH = Array(s5.length - 1).fill(new String()), this.strings = s5) : this._$AH = E;
  }
  _$AI(t6, i9 = this, s5, e12) {
    const h5 = this.strings;
    let o14 = false;
    if (void 0 === h5) t6 = S2(this, t6, i9, 0), o14 = !c3(t6) || t6 !== this._$AH && t6 !== T, o14 && (this._$AH = t6);
    else {
      const e13 = t6;
      let n10, r9;
      for (t6 = h5[0], n10 = 0; n10 < h5.length - 1; n10++) r9 = S2(this, e13[s5 + n10], i9, n10), r9 === T && (r9 = this._$AH[n10]), o14 ||= !c3(r9) || r9 !== this._$AH[n10], r9 === E ? t6 = E : t6 !== E && (t6 += (r9 ?? "") + h5[n10 + 1]), this._$AH[n10] = r9;
    }
    o14 && !e12 && this.j(t6);
  }
  j(t6) {
...
var L = class extends k {
  constructor(t6, i9, s5, e12, h5) {
    super(t6, i9, s5, e12, h5), this.type = 5;
  }
  _$AI(t6, i9 = this) {
    if ((t6 = S2(this, t6, i9, 0) ?? E) === T) return;
    const s5 = this._$AH, e12 = t6 === E && s5 !== E || t6.capture !== s5.capture || t6.once !== s5.once || t6.passive !== s5.passive, h5 = t6 !== E && (s5 === E || e12);
    e12 && this.element.removeEventListener(this.name, this, s5), h5 && this.element.addEventListener(this.name, this, t6), this._$AH = t6;
  }
  handleEvent(t6) {
...
var B = (t6, i9, s5) => {
  ...
  if (void 0 === h5) {
    ...
    e12._$litPart$ = h5 = new R(i9.insertBefore(l2(), t7), t7, void 0, s5 ?? {});
  }
...
var i4 = class extends y {
  ...
  update(t6) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t6), this._$Do = B(r9, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
var r4 = (t6 = o5, e12, r9) => {
  const { kind: n10, metadata: i9 } = r9;
  let s5 = globalThis.litPropertyMetadata.get(i9);
  if (void 0 === s5 && globalThis.litPropertyMetadata.set(i9, s5 = /* @__PURE__ */ new Map()), "setter" === n10 && ((t6 = Object.create(t6)).wrapped = true), s5.set(r9.name, t6), "accessor" === n10) {
    const { name: o14 } = r9;
    return { set(r10) {
      const n11 = e12.get.call(this);
      e12.set.call(this, r10), this.requestUpdate(o14, n11, t6);
    }, init(e13) {
      return void 0 !== e13 && this.C(o14, void 0, t6, e13), e13;
    } };
  }
  if ("setter" === n10) {
    const { name: o14 } = r9;
    return function(r10) {
      const n11 = this[o14];
      e12.call(this, r10), this.requestUpdate(o14, n11, t6);
    };
  }
  throw Error("Unsupported decorator location: " + n10);
};
function n4(t6) {
  return (e12, o14) => "object" == typeof o14 ? r4(t6, e12, o14) : ((t7, e13, o15) => {
    const r9 = e13.hasOwnProperty(o15);
    return e13.constructor.createProperty(o15, t7), r9 ? Object.getOwnPropertyDescriptor(e13, o15) : void 0;
  })(t6, e12, o14);
}
...
function t3(t6) {
  return (n10, o14) => {
    const c6 = "function" == typeof n10 ? n10 : n10[o14];
    Object.assign(c6, t6);
  };
}
...
function e5(e12, r9) {
  return (n10, s5, i9) => {
    const o14 = (t6) => t6.renderRoot?.querySelector(e12) ?? null;
    if (r9) {
      const { get: e13, set: r10 } = "object" == typeof s5 ? n10 : i9 ?? (() => {
        const t6 = Symbol();
        return { get() {
          return this[t6];
        }, set(e14) {
      ...
      return e4(n10, s5, { get() {
        let t6 = e13.call(this);
        return void 0 === t6 && (t6 = o14(this), (null !== t6 || this.hasUpdated) && r10.call(this, t6)), t6;
      } });
    }
    return e4(n10, s5, { get() {
      return o14(this);
...
var { I: t4 } = Z;
var e6 = (o14, t6) => void 0 === t6 ? void 0 !== o14?._$litType$ : o14?._$litType$ === t6;
var f3 = (o14) => void 0 === o14.strings;
var u3 = {};
var m2 = (o14, t6 = u3) => o14._$AH = t6;
...
var l3 = e7(class extends i5 {
  ...
  update(i9, [t6]) {
    ...
    const o14 = i9.element, l5 = i9.name;
    if (i9.type === t5.PROPERTY) {
      if (t6 === o14[l5]) return T;
    } else if (i9.type === t5.BOOLEAN_ATTRIBUTE) {
      if (!!t6 === o14.hasAttribute(l5)) return T;
    } else if (i9.type === t5.ATTRIBUTE && o14.getAttribute(l5) === t6 + "") return T;
    return m2(i9), t6;
  }
});
...
function n5(n10, r9, t6) {
  return n10 ? r9(n10) : t6?.(n10);
}
...
function i6(e12) {
  ...
  for (let n10 = r7(e12); n10; n10 = r7(n10)) {
...
var i7 = (t6, ...r9) => ({ _$litStatic$: r9.reduce(((r10, e12, a4) => r10 + ((t7) => {
...
var n6 = (t6) => (r9, ...e12) => {
  ...
  let c6, $3 = 0, f5 = false;
  for (; $3 < a4; ) {
    for (c6 = r9[$3]; $3 < a4 && void 0 !== (i9 = e12[$3], s5 = o7(i9)); ) c6 += s5 + r9[++$3], f5 = true;
    $3 !== a4 && u5.push(i9), n10.push(c6), $3++;
  }
  if ($3 === a4 && n10.push(r9[a4]), f5) {
    const t7 = n10.join("$$lit$$");
    void 0 === (r9 = l4.get(t7)) && (n10.raw = n10, l4.set(t7, r9 = n10)), e12 = u5;
  }
  return t6(r9, ...e12);
};
var u4 = n6(x);
...
var e10 = class extends i5 {
  constructor(i9) {
    if (super(i9), this.it = E, i9.type !== t5.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(r9) {
...
var o9 = e7(class extends i5 {
  ...
  render(t6) {
    return Object.keys(t6).reduce(((e12, r9) => {
      const s5 = t6[r9];
  ...
  update(e12, [r9]) {
    ...
    for (const t6 of this.ft) null == r9[t6] && (this.ft.delete(t6), t6.includes("-") ? s5.removeProperty(t6) : s5[t6] = null);
    for (const t6 in r9) {
      const e13 = r9[t6];
      if (null != e13) {
        this.ft.add(t6);
        const r10 = "string" == typeof e13 && e13.endsWith(i8);
        t6.includes("-") || r10 ? s5.setProperty(t6, r10 ? e13.slice(0, -11) : e13, r10 ? n7 : "") : s5[t6] = e13;
      }
    }
    return T;
  }
...
(function(w2) {
  function B2(t6, c6, a4, e12) {
    ...
    b3.a = function(b4, a5) {
      b4 -= e12;
      a5 -= e12;
      return 0 > b4 || b4 >= r9 || 0 > a5 || a5 >= r9 ? false : h5.a(b4, a5);
    };
    return b3;
  }
  function C2(t6, c6, a4, e12, b3, h5, r9, d3, g2, x2) {
    function u5(b4, a5, f5, c7, d4, r10, g3) {
      b4 ? (t6.lineTo(a5 + r10, f5 + g3), t6.arcTo(a5, f5, c7, d4, h5)) : t6.lineTo(a5, f5);
    }
    r9 ? t6.moveTo(c6 + h5, a4) : t6.moveTo(c6, a4);
    u5(d3, e12, a4, e12, b3, -h5, 0);
    u5(g2, e12, b3, c6, b3, 0, -h5);
    u5(x2, c6, b3, c6, a4, h5, 0);
    u5(r9, c6, a4, e12, a4, 0, h5);
  }
  function z2(t6, c6, a4, e12, b3, h5, r9, d3, g2, x2) {
  ...
  function y3(t6, c6) {
    a: {
      var a4 = c6.text, e12 = c6.v, b3 = c6.N, h5 = c6.K, r9 = c6.P;
      b3 = Math.max(1, b3 || 1);
      for (h5 = Math.min(40, h5 || 40); b3 <= h5; b3 += 1) try {
        var d3 = B2(a4, e12, b3, r9);
        break a;
      } catch (J) {
      }
      d3 = void 0;
    ...
    h5 = c6.size / e12;
    a4.beginPath();
    for (r9 = 0; r9 < e12; r9 += 1) for (b3 = 0; b3 < e12; b3 += 1) {
      var g2 = a4, x2 = c6.left + b3 * h5, u5 = c6.top + r9 * h5, p3 = r9, q = b3, f5 = d3.a, k2 = x2 + h5, m3 = u5 + h5, D = p3 - 1, E2 = p3 + 1, n10 = q - 1, l5 = q + 1, y4 = Math.floor(Math.min(0.5, Math.max(0, c6.R)) * h5), v3 = f5(p3, q), I2 = f5(D, n10), w3 = f5(D, q);
      D = f5(D, l5);
      var F = f5(p3, l5);
      l5 = f5(E2, l5);
      q = f5(
  ...
  function C2(c6, a4) {
    function e12(b4, h6) {
      for (var a5 = -1; 7 >= a5; a5 += 1) if (!(-1 >= b4 + a5 || d3 <= b4 + a5)) for (var c7 = -1; 7 >= c7; c7 += 1) -1 >= h6 + c7 || d3 <= h6 + c7 || (r9[b4 + a5][h6 + c7] = 0 <= a5 && 6 >= a5 && (0 == c7 || 6 == c7) || 0 <= c7 && 6 >= c7 && (0 == a5 || 6 == a5) || 2 <= a5 && 4 >= a5 && 2 <= c7 && 4 >= c7 ? true : false);
    }
    function b3(b4, a5) {
      ...
      for (k2 = 0; k2 < f5.length; k2 += 1) for (m3 = 0; m3 < f5.length; m3 += 1) {
        p3 = f5[k2];
        var q = f5[m3];
        if (null == r9[p3][q]) for (var n10 = -2; 2 >= n10; n10 += 1) for (var l5 = -2; 2 >= l5; l5 += 1) r9[p3 + n10][q + l5] = -2 == n10 || 2 == n10 || -2 == l5 || 2 == l5 || 0 == n10 && 0 == l5;
      }
      for (f5 = 8; f5 < d3 - 8; f5 += 1) null == r9[f5][6] && (r9[f5][6] = 0 == f5 % 2);
      for (f5 = 8; f5 < d3 - 8; f5 += 1) null == r9[6][f5] && (r9[6][f5] = 0 == f5 % 2);
      f5 = y3.w(h5 << 3 | a5);
      for (k2 = 0; 15 > k2; k2 += 1) m3 = !b4 && 1 == (f5 >> k2 & 1), r9[6 > k2 ? k2 : 8 > k2 ? k2 + 1 : d3 - 15 + k2][8] = m3, r9[8][8 > k2 ? d3 - k2 - 1 : 9 > k2 ? 15 - k2 : 14 - k2] = m3;
      r9[d3 - 8][8] = !b4;
      if (7 <= c6) {
        f5 = y3.A(c6);
        for (k2 = 0; 18 > k2; k2 += 1) m3 = !b4 && 1 == (f5 >> k2 & 1), r9[Math.floor(k2 / 3)][k2 % 3 + d3 - 8 - 3] = m3;
        for (k2 = 0; 18 > k2; k2 += 1) m3 = !b4 && 1 == (f5 >> k2 & 1), r9[k2 % 3 + d3 - 8 - 3][Math.floor(k2 / 3)] = m3;
      }
      if (null == g2) {
        b4 = t6.I(c6, h5);
        f5 = B2();
      ...
      for (q = d3 - 1; 0 < q; q -= 2) for (6 == q && --q; ; ) {
        for (n10 = 0; 2 > n10; n10 += 1) null == r9[k2][q - n10] && (l5 = false, p3 < b4.length && (l5 = 1 == (b4[p3] >>> m3 & 1)), a5(k2, q - n10) && (l5 = !l5), r9[k2][q - n10] = l5, --m3, -1 == m3 && (p3 += 1, m3 = 7));
        k2 += f5;
        if (0 > k2 || d3 <= k2) {
          k2 -= f5;
          f5 = -f5;
    ...
    var h5 = A2[a4], r9 = null, d3 = 0, g2 = null, x2 = [], u5 = { u: function(b4) {
      b4 = w2(b4);
      x2.push(b4);
      g2 = null;
    }, a: function(b4, a5) {
  ...
  function z2(c6, a4) {
    ...
    var e12 = (function() {
      ...
      for (var r9 = Array(c6.length - b4 + a4), d3 = 0; d3 < c6.length - b4; d3 += 1) r9[d3] = c6[d3 + b4];
      return r9;
    })(), b3 = { c: function(b4) {
      return e12[b4];
    }, b: function() {
...
var s4 = (i9, t6) => {
  ...
  for (const i10 of e12) i10._$AO?.(t6, false), s4(i10, t6);
  return true;
};
var o10 = (i9) => {
  let t6, e12;
...
function h3(i9) {
  void 0 !== this._$AN ? (o10(this), this._$AM = i9, r8(this)) : this._$AM = i9;
}
function n8(i9, t6 = false, e12 = 0) {
  const r9 = this._$AH, h5 = this._$AN;
  if (void 0 !== h5 && 0 !== h5.size) if (t6) if (Array.isArray(r9)) for (let i10 = e12; i10 < r9.length; i10++) s4(r9[i10], false), o10(r9[i10]);
  else null != r9 && (s4(r9, false), o10(r9));
  else s4(this, i9);
}
var c5 = (i9) => {
  i9.type == t5.CHILD && (i9._$AP ??= n8, i9._$AQ ??= h3);
};
var f4 = class extends i5 {
  ...
  _$AT(i9, t6, e12) {
    super._$AT(i9, t6, e12), r8(this), this.isConnected = i9._$AU;
  }
  _$AO(i9, t6 = true) {
    i9 !== this.isConnected && (this.isConnected = i9, i9 ? this.reconnected?.() : this.disconnected?.()), t6 && (s4(this, i9), o10(this));
  }
  setValue(t6) {
...
var n9 = e7(class extends f4 {
  ...
  update(i9, [s5]) {
    const e12 = s5 !== this.G;
    return e12 && void 0 !== this.G && this.rt(void 0), (e12 || this.lt !== this.ct) && (this.G = s5, this.ht = i9.options?.host, this.rt(this.ct = i9.element)), E;
  }
  rt(t6) {
    if (this.isConnected || (t6 = void 0), "function" == typeof this.G) {
      const i9 = this.ht ?? globalThis;
      let s5 = o11.get(i9);
      void 0 === s5 && (s5 = /* @__PURE__ */ new WeakMap(), o11.set(i9, s5)), void 0 !== s5.get(this.G) && this.G.call(this.ht, void 0), s5.set(this.G, t6), void 0 !== t6 && this.G.call(this.ht, t6);
...
function rgbToHsl(r9, g2, b3) {
  r9 = bound01(r9, 255);
  g2 = bound01(g2, 255);
  b3 = bound01(b3, 255);
  const max2 = Math.max(r9, g2, b3);
  const min2 = Math.min(r9, g2, b3);
  let h5 = 0;
  let s5 = 0;
...
function hslToRgb(h5, s5, l5) {
  ...
  if (s5 === 0) {
    ...
    const p3 = 2 * l5 - q;
    r9 = hue2rgb(p3, q, h5 + 1 / 3);
    g2 = hue2rgb(p3, q, h5);
    b3 = hue2rgb(p3, q, h5 - 1 / 3);
  }
  return { r: r9 * 255, g: g2 * 255, b: b3 * 255 };
}
function rgbToHsv(r9, g2, b3) {
  r9 = bound01(r9, 255);
  g2 = bound01(g2, 255);
  b3 = bound01(b3, 255);
  const max2 = Math.max(r9, g2, b3);
  ...
  return { h: h5, s: s5, v: v2 };
}
function hsvToRgb(h5, s5, v2) {
  h5 = bound01(h5, 360) * 6;
  s5 = bound01(s5, 100);
  v2 = bound01(v2, 100);
  ...
  const p3 = v2 * (1 - s5);
  const q = v2 * (1 - f5 * s5);
  const t6 = v2 * (1 - (1 - f5) * s5);
  const mod = i9 % 6;
  const r9 = [v2, q, p3, p3, t6, v2][mod];
  const g2 = [t6, v2, v2, q, p3, p3][mod];
  const b3 = [p3, p3, t6, v2, v2, q][mod];
  return { r: r9 * 255, g: g2 * 255, b: b3 * 255 };
}
function rgbToHex(r9, g2, b3, allow3Char) {
  const hex = [
...
function rgbaToHex(r9, g2, b3, a4, allow4Char) {
  const hex = [
    pad2(Math.round(r9).toString(16)),
    pad2(Math.round(g2).toString(16)),
    pad2(Math.round(b3).toString(16)),
...
function cmykToRgb(c6, m3, y3, k2) {
  ...
  return { r: r9, g: g2, b: b3 };
}
function rgbToCmyk(r9, g2, b3) {
  let c6 = 1 - r9 / 255;
  let m3 = 1 - g2 / 255;
  let y3 = 1 - b3 / 255;
...
function inputToRGB(color) {
  ...
  if (typeof color === "object") {
    if (isValidCSSUnit(color.r) && isValidCSSUnit(color.g) && isValidCSSUnit(color.b)) {
      ...
      rgb = hsvToRgb(color.h, s5, v2);
      ok = true;
      format = "hsv";
    } else if (isValidCSSUnit(color.h) && isValidCSSUnit(color.s) && isValidCSSUnit(color.l)) {
      s5 = convertToPercentage(color.s);
      l5 = convertToPercentage(color.l);
      rgb = hslToRgb(color.h, s5, l5);
      ok = true;
      format = "hsl";
...
var TinyColor = class _TinyColor {
  ...
  toHsvString() {
    ...
    return this.a === 1 ? `hsv(${h5}, ${s5}%, ${v2}%)` : `hsva(${h5}, ${s5}%, ${v2}%, ${this.roundA})`;
  }
  /**
  ...
  toHslString() {
    ...
    return this.a === 1 ? `hsl(${h5}, ${s5}%, ${l5}%)` : `hsla(${h5}, ${s5}%, ${l5}%, ${this.roundA})`;
  }
  /**
  ...
  toRgbString() {
    ...
    return this.a === 1 ? `rgb(${r9}, ${g2}, ${b3})` : `rgba(${r9}, ${g2}, ${b3}, ${this.roundA})`;
  }
  /**
   * Returns the object as a RGBA object.
   */
  ...
  monochromatic(results = 6) {
    ...
    while (results--) {
      res.push(new _TinyColor({ h: h5, s: s5, v: v2 }));
...
function* o12(o14, f5) {
  if (void 0 !== o14) {
    let i9 = 0;
    for (const t6 of o14) yield f5(t6, i9++);
  }
}

// node_modules/lit-html/directives/range.js
function* o13(o14, t6, e12 = 1) {
  const i9 = void 0 === t6 ? 0 : o14;
  t6 ??= o14;
  for (let o15 = i9; e12 > 0 ? o15 < t6 : t6 < o15; o15 += e12) yield o15;
}
...
async function getAllWindows() {
  return invoke("plugin:window|get_all_windows").then((windows) => windows.map((w2) => new Window(w2, {
    // @ts-expect-error `skip` is not defined in the public API but it is handled by the constructor
    skip: true
  })));
}
...
var Window = class {
  ...
  constructor(label, options = {}) {
    ...
    if (!(options === null || options === void 0 ? void 0 : options.skip)) {
      ...
      }).then(async () => this.emit("tauri://created")).catch(async (e12) => this.emit("tauri://error", e12));
    }
  }
  /**
  ...
  static async getByLabel(label) {
    var _a;
    return (_a = (await getAllWindows()).find((w2) => w2.label === label)) !== null && _a !== void 0 ? _a : null;
  }
  /**
  ...
  static async getFocusedWindow() {
    for (const w2 of await getAllWindows()) {
  ...
  async innerPosition() {
    return invoke("plugin:window|inner_position", {
      label: this.label
    }).then((p3) => new PhysicalPosition(p3));
  }
  /**
  ...
  async setSize(size3) {
    return invoke("plugin:window|set_size", {
      label: this.label,
      value: size3 instanceof Size ? size3 : new Size(size3)
    });
  }
  /**
   ...
   * @returns A promise indicating the success or failure of the operation.
   */
  async setMinSize(size3) {
    return invoke("plugin:window|set_min_size", {
      label: this.label,
      value: size3 instanceof Size ? size3 : size3 ? new Size(size3) : null
    });
  }
  /**
  ...
  async onResized(handler) {
    return this.listen(TauriEvent.WINDOW_RESIZED, (e12) => {
      e12.payload = new PhysicalSize(e12.payload);
      handler(e12);
    });
  }
  /**
  ...
  async onMoved(handler) {
    return this.listen(TauriEvent.WINDOW_MOVED, (e12) => {
      e12.payload = new PhysicalPosition(e12.payload);
      handler(e12);
    });
  }
  /**
...
async function getAllWebviews() {
  return invoke("plugin:webview|get_all_webviews").then((webviews) => webviews.map((w2) => new Webview(new Window(w2.windowLabel, {
    // @ts-expect-error `skip` is not defined in the public API but it is handled by the constructor
    skip: true
  }), w2.label, {
    // @ts-expect-error `skip` is not defined in the public API but it is handled by the constructor
...
var Webview = class {
  ...
  static async getByLabel(label) {
    var _a;
    return (_a = (await getAllWebviews()).find((w2) => w2.label === label)) !== null && _a !== void 0 ? _a : null;
  }
  /**
...
async function getAllWebviewWindows() {
  return invoke("plugin:window|get_all_windows").then((windows) => windows.map((w2) => new WebviewWindow(w2, {
    // @ts-expect-error `skip` is not defined in the public API but it is handled by the constructor
    skip: true
  })));
}
var WebviewWindow = class _WebviewWindow {
  ...
  static async getByLabel(label) {
    var _a;
    const webview = (_a = (await getAllWebviewWindows()).find((w2) => w2.label === label)) !== null && _a !== void 0 ? _a : null;
    if (webview) {
...
function parseFileInfo(r9) {
  return {
    isFile: r9.isFile,
    isDirectory: r9.isDirectory,
    isSymlink: r9.isSymlink,
    size: r9.size,
    mtime: r9.mtime !== null ? new Date(r9.mtime) : null,
    atime: r9.atime !== null ? new Date(r9.atime) : null,
    birthtime: r9.birthtime !== null ? new Date(r9.birthtime) : null,
    readonly: r9.readonly,
    fileAttributes: r9.fileAttributes,
    dev: r9.dev,
    ino: r9.ino,
    mode: r9.mode,
    nlink: r9.nlink,
...
function fromBytes(buffer) {
  ...
  const size3 = bytes.byteLength;
  let x2 = 0;
  for (let i9 = 0; i9 < size3; i9++) {
    const byte = bytes[i9];
    x2 *= 256;
    x2 += byte;
  }
...
var decodeUtf8From = (from, offset3, length) => {
  let buffer;
  if (offset3 === void 0) {
    buffer = from;
  } else if (length === void 0) {
    buffer = from.subarray(offset3);
  } else {
    buffer = from.subarray(offset3, offset3 + length);
  }
  ...
  }
  {
    ...
    for (; idx + 3 < end; idx += 4) {
      const a4 = buffer[idx];
      const b3 = buffer[idx + 1];
      const c6 = buffer[idx + 2];
      const d3 = buffer[idx + 3];
      if ((a4 | b3 | c6 | d3) & 128) {
        return str + textDecoder.decode(buffer.subarray(idx));
      }
      str += fromCharCode(a4, b3, c6, d3);
    }
    for (; idx < end; idx++) {
      const x2 = buffer[idx];
      if (x2 & 128) {
...
var decode2 = (buf, offset3 = 0) => {
  ...
  do {
    ...
    b3 = buf[counter++];
    res += shift3 < 28 ? (b3 & REST) << shift3 : (b3 & REST) * Math.pow(2, shift3);
    shift3 += 7;
  } while (b3 >= MSB);
  return [res, counter - offset3];
};
...
var compareKeys = (a4, b3) => {
  return a4.length - b3.length || (a4 < b3 ? -1 : a4 > b3 ? 1 : 0);
};
...
var CarTileReader = class {
  ...
  async open() {
    this.#fh = await open2(this.#path, { read: true });
    this.#pos = 0;
    ...
    this.#cid = await create(CODEC_DCBOR, headerBytes);
    const meta = decode3(headerBytes);
    delete meta.version;
    delete meta.roots;
    Object.keys(meta.resources).forEach((k2) => {
      meta.resources[k2].src = toCidLink(meta.resources[k2].src).toJSON();
    });
    this.#meta = meta;
    let blockSize = await this.readVarint();
    while (blockSize !== false) {
      const cidBytes = new Uint8Array(36);
      const actuallyRead2 = await this.#fh.read(cidBytes);
      if (actuallyRead2 < 36) throw new RangeError(`Unexpected end of data reading CID`);
      this.#pos += 36;
      ...
      const size3 = blockSize - 36;
      this.#cidOffsets[cid] = { start: this.#pos, size: size3 };
      await this.#fh.seek(size3, SeekMode.Current);
      this.#pos += size3;
  ...
  async readVarint() {
    ...
    const [int, readForVarint] = decode2(buf);
...
// src/store.js
async function positionMainWindow() {
...
// src/el/app.js
customElements.define("ts-app", class extends i4 {
  static styles = [
    i`
      :host {
        display: flex;
...
lit-html/directives/style-map.js:
   ...
   *)
*/
//# sourceMappingURL=tessera.min.js.map
